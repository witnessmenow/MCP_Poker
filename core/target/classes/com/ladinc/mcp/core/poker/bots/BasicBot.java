        ...
        if (allowedActions.size() == 1) {
            ...
            if ((chenScore < chenScoreToPlay)) {
                ...
                if ((chenScore - chenScoreToPlay) >= ((20.0 - chenScoreToPlay) / 2.0)) {
                    ...
                    if (aggression == 0) {
                        // Never bet.
                        if (allowedActions.contains(PokerAction.CALL)) {
                        ...
                        if (allowedActions.contains(PokerAction.BET)) {
                            action = new BetAction(amount);
                        } else if (allowedActions.contains(PokerAction.RAISE)) {
                            action = new RaiseAction(amount);
                        } else if (allowedActions.contains(PokerAction.CALL)) {
                            action = PokerAction.CALL;
                        } else {
                            action = PokerAction.CHECK;
                        }
